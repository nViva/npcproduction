                                        ...
                                        <table class="table text-dark text-center" id="styled-table">
                                            <thead class="text-uppercase" >
                                                <tr class="table-active" >
                                                    ...
                                                    <th scope="col">Purchasing Unit/Price (Rwf)
                                                    </th><th scope="col">Initial Stock</th>
                                                    <th scope="col">Purchases</th>
                                                    <th scope="col">Purchases value (Rwf)</th>
                                                    <th scope="col">Total Stock</th>
                                                    <th scope="col">Sold Stock</th>
                                                    <th scope="col">Sold Stock Value (Rwf)</th>
                                                    <th scope="col">Selling Unit/Price (Rwf)</th>
                                                    <th scope="col">SALES VALUE (Rwf)</th>
                                                    <th scope="col">Quantity Damaged</th>
                                                    <th scope="col">Damages Value (Rwf)</th>
                 ...
                 while ($row = $result4->fetch_assoc()) 
         {
            ...
            $salaries=$summ1+$summ2;
               ...
               if($result -> num_rows>0 || $result3 -> num_rows>0 || $result4 -> num_rows>0){
                ...
                ?>
                 <tr style='font-size:24px;;color:black;background-color: #979A99'><th colspan="5">Total</th><th> <?php echo number_format($purchase_val); ?> </th><th></th><th></th><th><?php echo number_format($sold_stockval); ?></th><th></th><th><?php echo number_format($sales_val); ?></th><th></th><th><?php echo number_format($damages_val); ?></th><th><?php echo number_format($gross_profit) ?></th><th></th></tr>
                 

<tr style='font-size:24px;;color:black;'><th colspan="13">Salaries and Bonuses (Rwf)</th><th><?php echo number_format($salaries) ?></th><th></th></tr>

<tr style='font-size:24px;;color:black;'><th colspan="13">Expenses (Rwf)</th><th><?php echo number_format($exp) ?></th></tr>
<tr style='font-size:24px;;color:black;'><th colspan="13">Net Profit (Rwf)</th><th><?php echo number_format($gross_profit-$exp-$salaries) ?></th><th></th></tr>
                   <tr><th>
