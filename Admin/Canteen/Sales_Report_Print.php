...
<body  onload="window.print()">
            ...
            <div class="main-content-inner">
              ...
              <h4 class="header-title">NPC PRODUCTION REPORT</h4>
               <h4 class="header-title">CANTEEN SALES REPORT OF <?php echo $a;?> To <?php echo $b;?> AS ON <?php echo"".date("y-m-d");?></h4><hr>
            ...
            <?php 
               ...
               $sql = "SELECT products.productId,sales.productId,products.productName,sales.purchasing_price,sales.quantity,sales.selling_price,sales.salesDate FROM products JOIN sales ON products.productId=sales.productId WHERE sales.salesDate BETWEEN '".$a."' AND '".$b."' AND sales.location='Canteen'";
