...
mysqli_query($db,"UPDATE products SET productName='$name', purchasingPrice='$price',sellingPrice='$selling_price' WHERE productId='$id' AND location='Canteen'" );
...
$id = $_GET['id'];
$result = mysqli_query($db,"SELECT * FROM products WHERE productId='$id' AND location='Canteen'");
