...
<div>
            ...
            <div class="main-content-inner">
                <br>
                <h4 class="heading">Rejected Requests</h4>
      ...
      <?php 
               ...
               $sql = "SELECT * FROM requests WHERE location='Canteen' AND status='rejected'";
               $result = $db->query($sql);
          $count=0;
                 ...
                 while ($row = $result->fetch_assoc()) 
         {
            ...
            <?php
               ...
               <a href="rejected_print.php" ><font color="blue"> Print</font></a>
            ...
            ?>
            <tr><th colspan="8"><center><font color="red" size="24px"> No requests rejected for Canteen!</font></center></th></tr>
<?php
}
            ?>
