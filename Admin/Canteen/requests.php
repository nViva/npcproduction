...
<div>
            ...
            <div class="main-content-inner">
                <br>
                <h4 class="heading">Canteen Requests </h4> 
...
include('../../config.php');
               $sql = "SELECT * FROM requests WHERE location='Canteen' AND status !='rejected' AND status!='approved'";
               $result = $db->query($sql);
          $count=0;
          $sum=0;
                 ...
                 while ($row = $result->fetch_assoc()) 
         {
            ...
            ?>
            <tr><th colspan="8"><font color="red" size="18"> No request for Canteen!</font></th></tr>
<?php
}
            ?>
