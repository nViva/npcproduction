...
<div>
      ...
      <?php 
             include('../../config.php');
               ...
               $sql = "SELECT * FROM products WHERE productName LIKE '%$mysearch%' AND location='VIP'";
               $result = $db->query($sql);
          $count=0;
                 ...
                 while ($row = $result->fetch_assoc()) 
         {
            ...
            <th><center><a href="edit.php?id=<?php echo $row["productId"] ?>"><font color="red"> Edit</font></a>|| <a href="delete.php?id=<?php echo $row["productId"] ?>"><font color="red">  Delete</font></a></th>
