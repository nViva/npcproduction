...
<div>
            ...
            <div class="main-content-inner">
                <br>
                <h4 class="heading">VIP Approved Requests</h4>
      ...
      <?php 
             include('../../config.php');
               ...
               $sql = "SELECT * FROM requests WHERE location='VIP' AND status='approved' AND purchased!='yes'";
               $result = $db->query($sql);
          $count=0;
                 ...
                 while ($row = $result->fetch_assoc()) 
         {
            ...
            ?>
            <tr><th colspan="8"><font color="red" size="18px"> No approved requests for VIP!</font></</th></tr>
<?php
}
            ?>
                                            </tbody>
