...
<div>
      ...
      <?php 
               ...
               $sql = "SELECT * FROM requests WHERE location='VIP' AND status='rejected'";
               $result = $db->query($sql);
          $count=0;
                 ...
                 while ($row = $result->fetch_assoc()) 
         {
            ...
            ?>
            <tr><th colspan="8"><center><font color="red" size="24px"> No requests rejected for VIP!</font></center></th></tr>
<?php
}
            ?>
