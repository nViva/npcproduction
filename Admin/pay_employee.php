    ...
    ?>
      ...
      <?php 
                 ...
                 while ($row = $result->fetch_assoc()) 
         {
            ...
            <th><a href="pay_employee1.php?id=<?php echo $row["id"] ?>"><font color="red"> Pay</font></a> </th>
           ...
           <?php
                ...
                <tr class="database-data" style='font-size:24px;font-weight: bold;color: red;'> <th colspan="8">No employee to pay !!!</th></tr>
                <?php
}
