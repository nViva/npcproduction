                                        ...
                                        <table class="table text-dark text-center" id="styled-table">
                                            <thead class="text-uppercase">
                                                <tr class="table-active">
                                                    ...
                                                    <th scope="col">Unit Price (Rwf)</th>
                                                    <th scope="col">Total Price (Rwf)</th>
                                                   <th>Location</th>
                                                </tr>
                                            </thead>
                                            <tbody>
      <?php 
          include('../config.php');
            ...
            <?php
                 ...
                 ?>
                <tr style='font-size:24px;font-weight: bold;color: black;background-color: #979A99;'><th colspan="5">Total</th><th colspan="2"><?php echo number_format( $sum)." Rwf"; ?></th></tr>
                 <tr><th>
