<?php 
 include("menu.php");
?>
<div class="topnav" id="myTopnav"><form method="post" action="Purchases_Search.php">
...
<div>
      ...
      <?php 
              include('../../config.php');
               ...
               $result = mysqli_query($db, "SELECT * FROM requests WHERE location='Canteen' AND status='approved' AND purchased!='yes'");
