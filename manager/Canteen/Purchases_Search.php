...
<div>
            ...
            <div class="main-content-inner">
                ...
                <div >
                    ...
                    <!-- Contextual Classes start -->
                           ...
                           <th scope="col">Date:<input type="date" id="monthly" name="datee" value="<?php echo date('Y-m-d');?>"></th>
      ...
      <?php 
              ...
              $mysearch=$_POST["search"];
               ...
               $result = mysqli_query($db, "SELECT * FROM requests WHERE productName LIKE '%$mysearch%' AND location='Canteen' AND status='approved' AND purchased!='yes'");
...
$result = mysqli_query($db, "SELECT * FROM requests WHERE id='" . $products[$i] . "' AND location='Canteen' AND status='approved' AND purchased!='yes'");
...
?>
                   ...
                   <tr class="database-data" style="background-color: #2196f3;">
                    <th><?php echo $i+1 ?></th>
                      ...
                      <th> <input type="text" readonly="" name="selling_price[]" value="<?php echo $row[$i]["selling_price"]  ?>"></th>
