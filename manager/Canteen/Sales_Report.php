...
<div>
            ...
            <div class="main-content-inner">
                <br>
                <h4 class="heading"> Canteen Sales Report</h4>
      ...
      <?php 
               ...
               $sql = "SELECT products.productId,sales.productId,products.productName,sales.quantity,sales.purchasing_price,sales.selling_price,sales.salesDate FROM products JOIN sales ON products.productId=sales.productId WHERE sales.salesDate BETWEEN '".$a."' AND '".$b."' AND sales.location='Canteen'";
               $result = $db->query($sql);
                    $count=0;
