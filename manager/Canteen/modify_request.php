...
$id=$_POST['id'];
$quant=$_POST['quant'];
$sql2="UPDATE requests SET requested_quantity='$quant' WHERE productName='$id' AND location='Canteen' AND status='requested'";
...
$id = $_GET['id'];
$result = mysqli_query($db,"SELECT * FROM requests WHERE productName='$id' AND location='Canteen'AND status='requested'");
...
<div>
            ...
            <div class="main-content-inner">
                ...
                <form method="post" action="modify_request.php">
                <div >
                   ...
                   <tr class="database-data" style="background-color: #2196f3;">
                      ...
                      <th><input type="text" name="quant" value="<?php echo $quant ?>"></th>
