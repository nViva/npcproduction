...
<body  onload="window.print()">
            ...
            <div class="main-content-inner">
              ...
              <h4 class="header-title">NPC PRODUCTION REPORT</h4>
               <h4 class="header-title">VIP DAMAGES REPORT OF <?php echo $a;?> To <?php echo $b;?> AS ON <?php echo"".date("y-m-d");?></h4><hr>
            ...
            include('../../config.php');
               //mysql_query("insert into product VALUES(,'product_name','price','quant')");
                ...
                $sql = "SELECT products.productId,damages.productId,products.productName,damages.quantity,damages.purchasing_price,damages.damagesDate,damages.explanation FROM products JOIN damages ON products.productId=damages.productId WHERE damages.damagesDate BETWEEN '".$a."' AND '".$b."' AND damages.location='VIP'";
