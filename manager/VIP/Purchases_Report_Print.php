...
<body  onload="window.print()">
            ...
            <div class="main-content-inner">
              ...
              <h4 class="header-title">NPC PRODUCTION REPORT</h4>
               <h4 class="header-title"> VIP PURCHASES REPORT OF <?php echo $a;?> To <?php echo $b;?> AS ON <?php echo"".date("y-m-d");?></h4><hr>
            ...
            <?php 
             ...
             include('../../config.php');
               ...
               $sql = "SELECT products.productId,purchases.productId,products.productName,purchases.quantity,purchases.price,purchases.purchaseDate FROM products JOIN purchases ON products.productId=purchases.productId WHERE purchases.purchaseDate BETWEEN '".$a."' AND '".$b."' AND purchases.location='VIP'";
               $result = $db->query($sql);
                    $count=0;
