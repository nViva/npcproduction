...
<div>
      ...
      <?php 
              ...
              $mysearch=$_POST["search"];
               ...
               $result = mysqli_query($db, "SELECT * FROM requests WHERE productName LIKE '%$mysearch%' AND location='VIP' AND status='approved'");
...
$result = mysqli_query($db, "SELECT * FROM requests WHERE id='" . $products[$i] . "' AND location='VIP' AND status='approved'");
