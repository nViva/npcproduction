...
$id=$_POST['id'];
$quant=$_POST['quant'];
$sql2="UPDATE requests SET requested_quantity='$quant' WHERE productName='$id' AND location='VIP' AND status='requested'";
...
$id = $_GET['id'];
$result = mysqli_query($db,"SELECT * FROM requests WHERE productName='$id' AND location='VIP'AND status='requested'");
