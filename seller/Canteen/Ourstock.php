...
?>
 ...
 <div class="topnav" id="myTopnav"><form method="post" action="Ourstock_Search.php">
      <input type="text" placeholder="Search.." name="search" style="margin-top: 10px;" class="search"></form></div>
...
<div>
     ...
     if ($_GET['message']=='msg2') {
       echo "<p style='color:red;font-size:24px;float:left'>Sold successfully.</p>";
     }
      ...
      <?php 
                 ...
                 while ($row = $result->fetch_assoc()) 
         {
            ...
            <?php
               ...
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Stock_Print_Draft.php" ><font color="blue"> Print Draft</font></a>
                </th> </tr>
