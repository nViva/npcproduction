...
?>
 ...
 <div class="topnav" id="myTopnav"><form method="post" action="Sales_Search.php">
      <input type="text" placeholder="Search.." name="search" style="margin-top: 0px;" class="search">
...
<div>
    ...
    if ($_GET['message']=='msg3') {
       echo "<p style='color:red;font-size:24px;'>The entered quantity is greater than available.</p>";
     }
...
?>
                   ...
                   <tr class="database-data" style="background-color: #2196f3;">
                    <th><?php echo $i+1 ?></th>
                      ...
                      <th><input type="hidden" name="product_name[]" value="<?php echo $row[$i]["productName"]  ?>"><?php echo $row[$i]["balance"]  ?></th>
