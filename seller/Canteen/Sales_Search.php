...
<div>
    ...
    ?>
                <h4 class="heading">Canteen Sales</h4>
      ...
      <?php 
               ...
               $result = mysqli_query($db, "SELECT * FROM products WHERE balance!='0' AND productName LIKE '%$mysearch%' AND location='Canteen' ");
...
$result = mysqli_query($db, "SELECT * FROM products WHERE productName LIKE '%$mysearch%' AND productId='" . $products[$i] . "' AND location='Canteen'");
...
?>
            ...
            <?php
               ...
               <input type="submit" name="sell" value="Submit" style="" class="purchase-button">
                ...
                <tr class="database-data" style='font-size:24px;font-weight: bold;color: red;'> <th colspan="8">The product you searched is nto found !!!</th></tr>
                <?php
}
