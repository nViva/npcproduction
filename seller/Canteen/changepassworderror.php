...
<div>
            ...
            <div class="main-content-inner">
                ...
                <th colspan="6" >
              <font color="red">Wrong Old Password</font>. 
                </th></tr>
                                                <tr class="table-active">
...
?>
                   ...
                   <tr class="database-data" style="background-color: #2196f3;">
                      ...
                      <th> <input type="hidden" name="user_id" value="<?php echo $row["userID"]  ?>"><input type="password" name="oldPassword" placeholder="Enter Old Password"></th> ?></th>
