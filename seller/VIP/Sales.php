    ...
    ?>
      ...
      <?php 
              include('../../config.php');
               ...
               $result = mysqli_query($db, "SELECT * FROM products WHERE balance!='0' AND location='VIP' ");
...
$result = mysqli_query($db, "SELECT * FROM products WHERE productId='" . $products[$i] . "' AND location='VIP'");
